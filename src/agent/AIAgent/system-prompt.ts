...
function getSkillPrompt(skills: string[]) {
...
export const systemPrompt = (workspace: string, osType: string, skills: string[], memoryFilePath: string, agentRulesPath: string) => {
...
export const subSystemPrompt = (workspace: string, osType: string, skills: string[]) => {
